...
extension SwiftBetterPlayerPlugin {
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "setDataSource":
            ...
            let offlineFairplayConfig = dataSource["offlineFairplayConfig"] as? String
            ...
            if let assetArg = assetArg {
                ...
                player.setDataSourceURL(url, key: key, certificateUrl: certificateUrl, licenseUrl: licenseUrl, offlineFairplayConfig: offlineFairplayConfig, headers: headers, useCache: useCache, cacheKey: cacheKey, cacheManager: cacheManager, overriddenDuration: overriddenDuration, videoExtension: videoExtension)
            } else {
                result(FlutterMethodNotImplemented)
                return
            }
